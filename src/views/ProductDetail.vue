                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-5 col-md-6 col-12 col-xs-12 larg-image">
                            <div class="tab-content">
                                <div class="tab-pane fade" id="image-11">
                                    <a href="javascript:void(0)" class="long-img">
                                        <figure class="zoom" onmousemove="zoom(event)"
                                                style="background: url(src/assets/image/pro-page-image/pro-page-image.jpg)">
                                            <img src="../assets/image/pro-page-image/pro-page-image.jpg"
                                ...
                                <div class="tab-pane fade" id="image-22">
                                    <a href="javascript:void(0)" class="long-img">
                                        <figure class="zoom" onmousemove="zoom(event)"
                                                style="background-image: url(src/assets/image/pro-page-image/prro-page-image01.jpg)">
                                            <img src="../assets/image/pro-page-image/prro-page-image01.jpg"
                                                 class="img-fluid" alt="image">
                                        </figure>
                                    </a>
                                </div>
                                <div class="tab-pane fade show active" id="image-33">
                                    <a href="javascript:void(0)" class="long-img">
                                        <figure class="zoom" onmousemove="zoom(event)"
                                                style="background-image: url(src/assets/image/pro-page-image/pro-page-image1-1.jpg)">
                                            <img src="../assets/image/pro-page-image/pro-page-image1-1.jpg"
                                                 class="img-fluid" alt="image">
                                        </figure>
                                    </a>
                                </div>
                                <div class="tab-pane fade" id="image-44">
                                    <a href="javascript:void(0)" class="long-img">
                                        <figure class="zoom" onmousemove="zoom(event)"
                                                style="background-image: url(src/assets/image/pro-page-image/pro-page-image1.jpg)">
                                            <img src="../assets/image/pro-page-image/pro-page-image1.jpg"
                                                 class="img-fluid" alt="image">
                                        </figure>
                                    </a>
                                </div>
                                <div class="tab-pane fade" id="image-55">
                                    <a href="javascript:void(0)" class="long-img">
                                        <figure class="zoom" onmousemove="zoom(event)"
                                                style="background-image: url(src/assets/image/pro-page-image/pro-page-image2.jpg)">
                                            <img src="../assets/image/pro-page-image/pro-page-image2.jpg"
                                                 class="img-fluid" alt="image">
                                        </figure>
                                    </a>
                                </div>
                                <div class="tab-pane fade" id="image-66">
                                    <a href="javascript:void(0)" class="long-img">
                                        <figure class="zoom" onmousemove="zoom(event)"
                                                style="background-image: url(src/assets/image/pro-page-image/pro-page-image2-2.jpg)">
                                            <img src="../assets/image/pro-page-image/pro-page-image2-2.jpg"
                                                 class="img-fluid" alt="image">
                                        </figure>
                                    </a>
                                </div>
                                <div class="tab-pane fade" id="image-77">
                                    <a href="javascript:void(0)" class="long-img">
                                        <figure class="zoom" onmousemove="zoom(event)"
                                                style="background-image: url(src/assets/image/pro-page-image/pro-page-image3.jpg)">
                                            <img src="../assets/image/pro-page-image/pro-page-image3.jpg"
                                                 class="img-fluid" alt="image">
                                        </figure>
                                    </a>
                                </div>
                            ...
                            <ul class="nav nav-tabs pro-pag-5-slider owl-carousel owl-theme">
                                <li class="nav-item items">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#image-11"><img
                                        src="../assets/image/pro-page-image/image1.jpg" class="img-fluid"
                                        alt="image"></a>
                                </li>
                                <li class="nav-item items">
                                    <a class="nav-link" data-bs-toggle="tab" href="#image-22"><img
                                        src="../assets/image/pro-page-image/image2.jpg" class="img-fluid"
                                        alt="iamge"></a>
                                </li>
                                <li class="nav-item items">
                                    <a class="nav-link" data-bs-toggle="tab" href="#image-33"><img
                                        src="../assets/image/pro-page-image/image3.jpg" class="img-fluid"
                                        alt="image"></a>
                                </li>
                                <li class="nav-item items">
                                    <a class="nav-link" data-bs-toggle="tab" href="#image-44"><img
                                        src="../assets/image/pro-page-image/image4.jpg" class="img-fluid"
                                        alt="image"></a>
                                </li>
                                <li class="nav-item items">
                                    <a class="nav-link" data-bs-toggle="tab" href="#image-55"><img
                                        src="../assets/image/pro-page-image/image5.jpg" class="img-fluid"
                                        alt="image"></a>
                                </li>
                                <li class="nav-item items">
                                    <a class="nav-link" data-bs-toggle="tab" href="#image-66"><img
                                        src="../assets/image/pro-page-image/image6.jpg" class="img-fluid"
                                        alt="image"></a>
                                </li>
                                <li class="nav-item items">
                                    <a class="nav-link" data-bs-toggle="tab" href="#image-77"><img
                                        src="../assets/image/pro-page-image/image7.jpg" class="img-fluid"
                                        alt="image"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6 col-xl-7 col-md-6 col-12 col-xs-12 pro-info">
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                has been the industry's standard dummy text ever since the 1500s, when took a galley</p>
                            <div class="pro-items">
                            ...
                            <div class="pro-btn">
                                ...
                                <a href="cart-2.html" class="btn btn-style1"><i class="fa fa-shopping-bag"></i> Add to
                                    cart</a>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show" id="tab-2">
                                ...
                                <div class="customer-reviews">
                                    ...
                                    <h4 class="review-head">He also good and fresh fruit organic product see like
                                        look</h4>
                                    <span class="reviews-editor">Melvin louis <span class="review-name">on</span> fab 5, 2021</span>
                                    <p class="r-description">He also good and fresh fruit organic product see like
                                        look</p>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade show" id="tab-5">
                                <div class="more-description table-responsive">
                                    <table class="table table-bordered table-elastic table-condensed"
                                        ...
                                        <tr>
                                            <th scope="row">Carrot<br> 1 carrot, 7" long,<br> 1 1/4" diameter<br> (78
                                                g/2.8 oz)
                                            </th>
                                            <td>30</td>
                                            <td>0</td>
                                        ...
                                        <tr class="alert alert-warning">
                                            <th scope="row">Green&nbsp;Cabbage<br> 1/12 medium head<br> (84 g/3.0 oz)
                                            </th>
                                            <td>25</td>
                                            <td>0</td>
                                            <td>0</td>
                                        ...
                                        <tr>
                                            <th scope="row">Sweet Corn<br> kernels from 1<br> medium ear<br> (90 g/3.2
                                                oz)
                                            </th>
                                            <td>90</td>
                                            <td>20</td>
                                        ...
                                        <tr class="alert alert-warning">
                                            <th scope="row">Sweet Potato<br> 1 medium, 5" long,<br> 2" diameter<br> (130
                                                g/4.6 oz)
                                            </th>
                                            <td>100</td>
                                            <td>0</td>
                    ...
                    <div class="releted-products owl-carousel owl-theme">
                            ...
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-1.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-01.jpg"
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-2.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-02.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-3.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-03.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-4.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-04.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-5.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-05.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-6.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-06.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-7.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-07.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-8.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-08.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-9.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image" src="../assets/image/pro/pro-img-09.jpg"
                                             alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-10.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image"
                                             src="../assets/image/pro/pro-img-010.jpg" alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                                    <span class="p-text">New</span>
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-11.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image"
                                             src="../assets/image/pro/pro-img-011.jpg" alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">
                                    <span class="p-text">New</span>
                        ...
                        <div class="items">
                            <div class="tred-pro">
                                <div class="tr-pro-img">
                                    <a href="product-style-2.html">
                                        <img class="img-fluid" src="../assets/image/pro/pro-img-12.jpg" alt="pro-img1">
                                        <img class="img-fluid additional-image"
                                             src="../assets/image/pro/pro-img-012.jpg" alt="additional image">
                                    </a>
                                </div>
                                <div class="Pro-lable">

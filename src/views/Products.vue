        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="categories-page-filter">
                            ...
                            <ul class="all-option collapse" id="category-filter">
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Baker's rack <span class="grid-items">(3)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Bestseller<span class="grid-items">(15)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Breakfast <span class="grid-items">(13)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Dairy & chesse <span class="grid-items">(5)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Dairy & chesse <span class="grid-items">(12)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                ...
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Dinner <span class="grid-items">(8)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Featured product <span
                                        class="grid-items">(4)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Fresh fruits <span class="grid-items">(15)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Fresh meat <span class="grid-items">(20)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                ...
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Green seafood <span class="grid-items">(11)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Lunch <span class="grid-items">(3)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">New product <span class="grid-items">(17)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Organic dryfruit <span
                                        class="grid-items">(13)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Organic juice <span class="grid-items">(10)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Organic wine <span class="grid-items">(3)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Sea & fish <span class="grid-items">(9)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Special product <span class="grid-items">(7)</span></a>
                                </li>
                                <li class="grid-list-option">
                                    <input type="checkbox">
                                    <a href="javascript:void(0)">Starters <span class="grid-items">(2)</span></a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-9 col-md-8 col-12">
                    <div class="grid-list-banner" style="background: url(src/assets/image/slider17.jpg);">
                    ...
                    <div class="grid-4-product">
                        <div class="grid-list-select">
                            <ul class="grid-list">
                                ...
                                <li class="colloction-icn three-grid"><a href="grid-list.html"><i
                                    class="ti-layout-grid3"></i></a></li>
                                <li class="colloction-icn four-grid"><a href="grid-list-4.html" class="active"><i
                            ...
                            <ul class="grid-product">
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="#">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-1.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-01.jpg"
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-2.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-02.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-3.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-03.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-4.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-04.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-5.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-05.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-6.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-06.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-7.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-07.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-8.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-08.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-10.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-010.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                ...
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-13.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-013.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                    ...
                                    <div class="caption">
                                        ...
                                        <div class="pro-price">
                                            <span class="new-price">$200.00 USD</span>
                                        </div>
                                    </div>
                                </li>
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-11.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-011.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">
                                    ...
                                    <div class="caption">
                                        ...
                                        <div class="pro-price">
                                            <span class="new-price">$180.00 USD</span>
                                        </div>
                                    </div>
                                </li>
                                <li class="grid-items">
                                    <div class="tred-pro">
                                        <div class="tr-pro-img">
                                            <a href="product.html">
                                                <img class="img-fluid" src="../assets/image/pro/pro-img-14.jpg"
                                                     alt="pro-img1">
                                                <img class="img-fluid additional-image"
                                                     src="../assets/image/pro/pro-img-014.jpg"
                                                     alt="additional image">
                                            </a>
                                        </div>
                                        <div class="Pro-lable">

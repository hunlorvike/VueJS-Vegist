                ...
                <div class="col-xl-3 col-xs-12 col-sm-12 col-md-12 col-lg-4">
                    <div class="cart-total">
                        ...
                        <div class="cart-info">
                            ...
                            <a href="javascript:void(0)" class="cart-calculate btn btn-style1">Calculate</a>
                        </div>
                        <div class="shop-total">
                            <span>Total</span>
                            <span class="total-amount">$78.44 CAD</span>
                        </div>
                        <a href="checkout-2.html" class="check-link btn btn-style1">Checkout</a>
                    </div>
                </div>
                            ...
                            <div class="cart-all-pro">
                                <div class="cart-pro">
                                    <div class="cart-pro-image">
                                        <a href="product.html"><img src="../assets/image/cart-page/cart-1/image1.jpg"
                    ...
                    <div class="cart-area">
                        <div class="cart-details">
                            <div class="cart-all-pro">
                                <div class="cart-pro">
                                    <div class="cart-pro-image">
                                        <a href="product.html"><img src="../assets/image/cart-page/cart-1/image3.jpg"
                                                                    class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                    ...
                    <div class="cart-area">
                        <div class="cart-details">
                            <div class="cart-all-pro">
                                <div class="cart-pro">
                                    <div class="cart-pro-image">
                                        <a href="product.html"><img src="../assets/image/cart-page/cart-1/image2.jpg"
                                                                    class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                            ...
                            <div class="other-link">
                                <ul class="c-link">
                                    <li class="cart-other-link"><a href="grid-list.html" class="btn btn-style1">Update
                                        cart</a></li>
                                    <li class="cart-other-link"><a href="grid-list.html" class="btn btn-style1">Continue
                                        shopping</a></li>
                                    <li class="cart-other-link"><a href="index2.html" class="btn btn-style1">Clear
                                        cart</a></li>
                                </ul>
                            </div>
                        </div>
